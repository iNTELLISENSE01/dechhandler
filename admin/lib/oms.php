...
class Oms
{
	...
	public function login_check($data)
	{
		...
		if ($result) {
			...
			Session::set("admin-id", $result->id);
			Session::set("admin-name", $result->name);
			Session::set("admin-username", $result->username);
			Session::set("admin-loginmsg", '<p class="text-success"><strong>Success! </strong>You are Login.</p>');
